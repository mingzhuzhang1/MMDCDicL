            ...
            if current_step % opt['train']['checkpoint_test'] == 0:
                ...
                for test_loader in tqdm(test_loaders):
                    ...
                    for test_data in tqdm(test_loader):
                        ...
                        psnr, ssim, psnr_m, ssim_m = model.cal_metrics()
                        ...
                        if current_step % opt['train'][
                            ...
                            model.save_visuals(test_set.tag_x)
                    ...
                    if test_set.tag_x not in tags:
                        tags.append(test_set.tag_x)
                ...
                start = time.time()
                model.save(logger, current_step)
